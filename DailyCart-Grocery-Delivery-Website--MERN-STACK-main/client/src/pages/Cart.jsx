...
const Cart = () => {
    ...
    const{products,user,setcartitem,axios,CURRENCY,cartitem,removefromcart,getcartcount,updatecartitem,navigate,getcartamount}=useAppcontext(); 
    ...
    if (!user) return <div className="mt-20 text-center">Loading your cart...</div>;
